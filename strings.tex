...
\begin{mathpar}
  ...
  \judgment{
    ...
    \IHExpVarP_1 \coloneqq \IHExpCast{\IHExpVar_1}{\HTypVar_1}{\HTypStr} \\
    \IHExpVarP_2 \coloneqq \IHExpCast{\IHExpVar_2}{\HTypVar_2}{\HTypNum} \\
    \IHExpVarP_3 \coloneqq \IHExpCast{\IHExpVar_3}{\HTypVar_3}{\HTypNum} \\
  }{
    \ElabArrow{
      \synType{\HTypCtx}{\HExpStrSub{\HExpVar_1}{\HExpVar_2}{\HExpVar_3}}{\HTypStr}
    }{
