...
\newcommand{\HTypNumC}{\texttt{num}}
\newcommand{\HTypStrC}{\texttt{str}}
\newcommand{\HTypArrowC}[2]{(#1 \to #2)}

% H-expressions
\newcommand{\HExp}{\texttt{HExp}}
\newcommand{\HExpVar}{\dot{e}}
\newcommand{\HExpVarP}{\dot{e}'}
\newcommand{\HExpStrLit}{\texttt{"}\ubar{s}\texttt{"}}
...
\newcommand{\IHExpStrLit}{\texttt{"}\ubar{s}\texttt{"}}
...
% Action expressions
\newcommand{\AcExpArrow}[2]{#1 \stackrel{\alpha}{\longrightarrow} #2}
